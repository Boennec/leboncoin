...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Enchere::class, mappedBy="IDuser")
     */
    private $encheres;
    ...
    public function removeEnchere(Enchere $enchere): self
    {
        if ($this->encheres->removeElement($enchere)) {
            ...
            if ($enchere->getIDuser() === $this) {
                $enchere->setIDuser(null);
            }
        }
    ...
    public function removeMessageEnvoye(Message $message): self
    {
        if ($this->messages_envoyes->removeElement($message)) {
            // set the owning side to null (unless already changed)
            if ($message->getIDenvoi() === $this) {
                $message->setIDenvoi(null);
            }
        }
    ...
    public function addMessagesRecu(Message $message): self
    {
